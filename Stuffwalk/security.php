<?php 
/*
	storage.php -runko; vaihda security.php
	Sisältö
	- ilmoita tuotteen varastamisesta
	- ilmoita tuotteen löytymisestä
	- ilmoita tuotteen sijainnista
	- ilmoita 
	
	kaapattu ajoneuvo
	kuva -> rekisterinumero -> ajoneuvo_id
...
function tracking()
{
	$cart = mysql_query("SELECT visit_time, browser, ip_address, dns_address FROM tracking ORDER BY visit_time DESC");
	$content = "<h3>Tracking</h3>";
	$content .= "<table border=1>";
	$content .= "<tr><th>Vierailuaika</th><th>IP-osoite</th><th>DNS-osoite</th><th>Selaintiedot</th></tr>";
	while ($row = mysql_fetch_assoc($cart)) {
			$visit_time = $row['visit_time'];
			$browser = $row['browser'];
			$ip = $row['ip_address'];
			$dns = $row['dns_address'];
			$content .= "<tr><td>" . $visit_time . "</td><td>" . $ip . "</td><td>" . $dns . "</td><td>" . $browser . "</td></tr>";
	}
	$content .= "</table>";
	$content .= "<h1>Memory get usage</h1>";
	$content .= "<!-- http://php.net/manual/en/function.memory-get-usage.php -->";
	$content .= memory_get_usage();
	$content .= "<br/>";
	$content .= memory_get_peak_usage();
	$content .= "<h1>CPU</h1>";
	$content .= "<!-- http://php.net/manual/en/function.sys-getloadavg.php -->";
	// $load = sys_getloadavg();
	// if ($load[0] > 80) {
	// $content .= "Help!";
	// }
...
$explorer .= "<input type=\"text\" name=\"search\" style=\"margin:5 0 0 8.5%; height: 25px\" size=\"40px\" />
...
<a href=\"security.php\" style=\"background-color: #D3D3D3;font-weight: bold;\">Security</a>
...
<li style=\"\"><a href=\"showcase.php\">Market Flow</a></li>
...
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Estetyt aiheet</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Vehicles</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Furniture</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Clothes</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Music Instruments</label>";
...
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Sallitut käyttäjäluokitukset</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Green] Hyvämaineiset</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Yellow] Pienellä riskillä olevat</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Red] Riskialttiit</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Black] Estetyt/Hylätyt</label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Sallitut alueet</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Suomi</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Ruotsi</label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Estetyt alueet</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Miami, USA</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> Kenya, Africa</label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Sallitut verkostot</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> University of Jyväskylä</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> KOAS</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> JAMK Jyväskylä University Of Applied Sciences</label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Estetyt verkostot</h3>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Green] Hyvämaineiset</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Yellow] Pienellä riskillä olevat</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Red] Riskialttiit</label>";
$head .= "<label class=\"interest\"><input type=\"checkbox\" /> [Black] Estetyt/Hylätyt</label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "<h3>Estetyt käyttäjät</h3>";
$head .= "<label class=\"interest\">Nimi <input type=\"text\" /> </label>";
$head .= "<label class=\"interest\">ID <input type=\"text\" /> </label>";
$head .= "<input type=\"submit\" value=\"Edit/Save\" style=\"float: right;\">";
$head .= "<hr/>";
$head .= "$tracking";
$head .= "</div>"; 
